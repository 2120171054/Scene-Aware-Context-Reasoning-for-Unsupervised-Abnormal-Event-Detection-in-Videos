...
def main(args):
    ...
    h5_fn = 'avenue_'+args.mode+'_imdb_' + str(args.image_size) + '.h5'
    # write the h5 file
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_size', default=1800, type=int)
    parser.add_argument('--imh5_dir', default='../data/avenue/')
