...
from data_loader import get_loader,my_get_loader
...
def main(config):
    ...
    data_loader = my_get_loader(config.data_path, batch_size=config.batch_size, mode=config.mode)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gmm_k', type=int, default=10)
    ...
    # Path
    parser.add_argument('--data_path', type=str, default='./data/avenue/')
    parser.add_argument('--log_path', type=str, default='./gdgmm/logs')
    parser.add_argument('--model_save_path', type=str, default='./gdgmm/models')
